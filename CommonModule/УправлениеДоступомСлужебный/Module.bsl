...
Процедура УстановкаПараметровСеанса(ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ГруппыДоступа.ЗначенияДоступа КАК ЗначенияДоступаПрофилейГруппДоступа
	|		ПО (ЗначенияДоступаПрофилейГруппДоступа.Ссылка = ГруппыДоступа.Ссылка)
	|			И (ЗначенияДоступаПрофилейГруппДоступа.ВидДоступа = ВидыДоступаПрофилейГруппДоступа.ВидДоступа)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ГруппыДоступа.ВидыДоступа КАК ВидыДоступаГруппДоступа
	|		ПО (ВидыДоступаГруппДоступа.Ссылка = ГруппыДоступа.Ссылка)
	|			И (ВидыДоступаГруппДоступа.ВидДоступа = ВидыДоступаПрофилейГруппДоступа.ВидДоступа)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ГруппыДоступа.ЗначенияДоступа КАК ЗначенияДоступаГруппДоступа
	|		ПО (ЗначенияДоступаГруппДоступа.Ссылка = ГруппыДоступа.Ссылка)
	|			И (ЗначенияДоступаГруппДоступа.ВидДоступа = ВидыДоступаПрофилейГруппДоступа.ВидДоступа)
	|ГДЕ
	|	НЕ(НЕ(ВидыДоступаПрофилейГруппДоступа.Предустановленный
	|						И НЕ ВидыДоступаПрофилейГруппДоступа.ДоступРазрешен)
	|				И ЗначенияДоступаПрофилейГруппДоступа.ВидДоступа ЕСТЬ NULL 
	|				И ЕСТЬNULL(ВидыДоступаГруппДоступа.ДоступРазрешен, ИСТИНА)
	|				И ЗначенияДоступаГруппДоступа.ВидДоступа ЕСТЬ NULL )";
...
Процедура ПриОпределенииСтандартныхТиповОбщихПредопределенныхДанных(МассивТипов) Экспорт
	...
	МассивТипов.Добавить(Тип("ПланВидовХарактеристикСсылка.ВидыДоступа"));
