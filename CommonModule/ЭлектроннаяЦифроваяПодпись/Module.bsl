...
Процедура ПриДобавленииОбработчиковСлужебныхСобытий(КлиентскиеОбработчики, СерверныеОбработчики) Экспорт
	...
	ИмяМодуля = "ЭлектроннаяЦифроваяПодпись";
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	ОбщегоНазначения.ДобавитьПереименование(Итог, "2.1.6.1", СтароеИмя, НовоеИмя, Библиотека);
...
// Возвращает структуру данных из файла подписи
//
// Параметры
