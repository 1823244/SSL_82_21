...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если Не Отказ И ЗакрытьФормуБезусловно <> Истина И Элементы.ПанельОсновная.ТекущаяСтраница <> Элементы.Начало Тогда
		
		УдалитьНастройкуОбмена(ИмяПланаОбмена, ОбластьДанныхКорреспондента);
...
&НаСервереБезКонтекста
Процедура УдалитьНастройкуОбмена(ИмяПланаОбмена, ОбластьДанныхКорреспондента)
